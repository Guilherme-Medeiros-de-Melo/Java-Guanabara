 ...
 * @author Gui
 */
public class OpeSwing extends javax.swing.JFrame {

    /**
     * Creates new form OpeSwing
     */
    public OpeSwing() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        inteiro = new javax.swing.JLabel();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(div)
                                    .addComponent(val, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(36, 36, 36)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int n1 = Integer.parseInt(val.getText());
        int n2 = Integer.parseInt(div.getText());
        float divi = n1/n2;
        float rest = (float)Math.sqrt(n1);
        inteiro.setText(Float.toString(divi));
        raiz.setText(Float.toString(rest));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpeSwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel inteiro;
